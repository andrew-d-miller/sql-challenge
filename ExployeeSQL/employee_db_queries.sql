...
FROM dept_employees JOIN employees ON dept_employees.emp_no=employees.emp_no
...
SELECT dept_employees.emp_no, employees.first_name, employees.last_name, departments.dept_name
FROM dept_employees 
